...
TEST_CASE("dev_registry: GET /mgmt/device", "[core] [dev_registry]") {
...

    {
        ...
        REQUIRE(resp == http::status_code::OK);
        REQUIRE(resp.value() == R"json({"id": 3,"createdAt": "2000-02-02","updatedAt": "2021-05-05","deviceName": "sensor1.testcloud2.arrowhead.aitia.eu","address": "address3","macAddress": "33:34:56:78:9a:bc","authenticationInfo": "ai3"})json");
    }
