...
TEST_CASE("rbcurl: Test connection to an on-line server", "[rbcurl] [client]") {
    ...
    auto kp = http::KeyProvider{ "data/test0093/tempsensor.testcloud1.publicCert.pem", "PEM", "data/test0093/tempsensor.testcloud1.private.key", "PEM", "12345", "data/test0093/tempsensor.testcloud1.caCert.pem" };
    auto rb = http::RB_Curl{ kp };
