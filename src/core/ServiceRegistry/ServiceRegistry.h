...
///////////////////////////////////////
    ...
    int handleGET(const std::string &_zUrl, std::string &response) final
    {
/*
        printf("\nGET received (URL: %s)\n", _szUrl);
...
*/
    ...
    int handlePOST(const std::string &_szUrl, std::string &response, const std::string &payload) final
    {
/*
        printf("\nPOST received (URL: %s)\n", _szUrl);
...
*/
    ...
    int handlePUT(const std::string &_szUrl, std::string &response, const std::string &payload) final
    {
/*        printf("PUT received\n");
        if(strstr(_szUrl, "serviceregistry") == NULL)
        {
...
*/
    ...
    int handlePATCH(const std::string &_szUrl, std::string &response, const std::string &payload) final
    {
/*
...
*/
    ...
    int handleDELETE(const std::string &_szUrl, std::string &response, const std::string &payload) final
    {
