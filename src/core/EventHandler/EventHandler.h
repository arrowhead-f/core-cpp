#ifndef _CORE_EVENTHANDLER_H_
#define _CORE_EVENTHANDLER_H_
...
template<typename DBPool, typename RB>class EventHandler final : public Core<DBPool, RB> {
