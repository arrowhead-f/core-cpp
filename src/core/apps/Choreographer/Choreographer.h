#ifndef _CORE_CHOREOGRAPHER_H_
#define _CORE_CHOREOGRAPHER_H_
...
template<typename DBPool, typename RB>class Choreographer final : public Core<DBPool, RB> {
