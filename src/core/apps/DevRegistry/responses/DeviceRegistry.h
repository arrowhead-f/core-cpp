 ...
 *     * ng201
 ********************************************************************************/
#ifndef _CORE_DEVREGISTRY_RESPONSES_DEVICEREGISTRY_H_
#define _CORE_DEVREGISTRY_RESPONSES_DEVICEREGISTRY_H_
...
namespace Responses {
    ...
    class DeviceRegistry : public JsonBuilder {
...
#endif  /* _CORE_DEVREGISTRY_RESPONSES_DEVICEREGISTRY_H_ */
