 ...
 *     * ng201
 ********************************************************************************/
#ifndef CORE_HELPERS_QUERYSTRING_H_
#define CORE_HELPERS_QUERYSTRING_H_
...
class QueryString {
    ...
    public:
        ...
        QueryString(const Uri &uri, std::initializer_list<const char*> sort) {
...
#endif  /* CORE_HELPERS_QUERYSTRING_H_ */
